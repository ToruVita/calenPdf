...
public class ClnUtils {
	...
	public static String get2472kou(int year, int month, int day) {
		int flg = check72(year, month, day);
		if(flg!=0){
			return kou72[(flg+1)%72];
		}else{
			return "";
		}
	}

	public static String getMonthNameJ(int month) {
		return monthNameJ[month-1];
	}
}
